...
pub trait Type<T>: Serialize + for<'a> Deserialize<'a> {
    fn reference(&self) -> &T;
}
...
pub trait Function<T>: Serialize + for<'a> Deserialize<'a> {
    fn reference(&self) -> &T;
}
...
pub trait Terminator: Serialize + for<'a> Deserialize<'a> {}
...
pub trait Expression: Serialize + for<'a> Deserialize<'a> {}
...
pub trait Statement: Serialize + for<'a> Deserialize<'a> {}

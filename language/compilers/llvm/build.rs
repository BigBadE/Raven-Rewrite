...
fn main() {
    ...
    match env::consts::ARCH {
        "x86_64" => match env::consts::OS {
            "windows" => setup_llvm(target.clone(), "https://github.com/BigBadE/LLVMBinaryBuilder/releases/download/release/Windows-x86_64.zip"),
            "linux" => setup_llvm(target.clone(), "https://github.com/BigBadE/LLVMBinaryBuilder/releases/download/release/Linux-x86_64.zip"),
...
/// Code from LLVM-sys's build.rs file
extern crate anyhow;
extern crate cc;
#[macro_use]
